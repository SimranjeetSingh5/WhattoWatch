...
import com.simranjeetsingh05.simplywrite.databinding.EditorFragmentBinding
    ...
    override fun onCreateView(
        ...
        viewModel.currentNote.observe(viewLifecycleOwner, Observer {
            val savedString = savedInstanceState?.getString(NOTE_TEXT_KEY)
             val cursorPositon = savedInstanceState?.getInt(CURSOR_POSITION_KEY)?:0
            binding.editor.setText(savedString?: it.text)
            binding.editor.setSelection(cursorPositon)
        })
