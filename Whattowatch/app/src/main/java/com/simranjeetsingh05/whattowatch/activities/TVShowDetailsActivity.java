...
import com.simranjeetsingh05.whattowatch.adapters.EpisodesAdapter;
import com.simranjeetsingh05.whattowatch.adapters.ImageSliderAdapter;
import com.simranjeetsingh05.whattowatch.databinding.ActivityTVShowDetailsBinding;
import com.simranjeetsingh05.whattowatch.databinding.LayoutEpisodesBottomSheetBinding;
                                    ...
                                    if (isTVShowAvailableInWatchlist) {
                                        compositeDisposable.add(tvShowDetailsViewModel.removeTVShowFromWatchlist(tvShow)
                                                ...
                                                .subscribe(() -> {
                                                    ...
                                                    Toast.makeText(getApplicationContext(), "Remove From watchlst", Toast.LENGTH_SHORT).show();
                                                    compositeDisposable.dispose();
                                                }));
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (i == position) {
                imageView.setImageDrawable(
                        ContextCompat.getDrawable(getApplicationContext(), R.drawable.backgrounf_slider_indicator_active)
                );
            } else {
                imageView.setImageDrawable(
